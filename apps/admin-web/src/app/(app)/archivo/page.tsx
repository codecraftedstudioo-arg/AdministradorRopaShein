...
import { PERMISOS, ESTADOS_ARCHIVO } from "@shein/shared";
...
export default async function ArchivoPage({
  ...
  const { filtros, orden, page, raw } = parseInventoryParams(sp, ESTADOS_ARCHIVO);
  ...
  return (
    <div>
      <PageHeader
        title="Archivo"
        description="Prendas vendidas y archivadas. La información nunca se elimina."
      />
      <InventoryView
